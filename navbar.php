...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        <a class="navbar-brand" href="<?php echo BASE_URL; ?>/">Complaint Management</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <?php elseif (isUser()): ?>
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/complaints/add_complaint.php">Add Complaint</a></li>
                   <!-- <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/complaints/view_complaint.php">My Complaints</a></li>-->
                <?php endif; ?>
